...
public class DownloadButton extends TextView {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mBackgroundColor = a.getColor(R.styleable.DownloadButton_backgroud_color, Color.parseColor("#6699ff"));
        mBackgroundSecondColor = a.getColor(R.styleable.DownloadButton_backgroud_second_color, Color.LTGRAY);
        mButtonRadius = a.getFloat(R.styleable.DownloadButton_radius, getMeasuredHeight() / 2);
        mTextColor = a.getColor(R.styleable.DownloadButton_text_color, mBackgroundColor);
        mTextCoverColor = a.getColor(R.styleable.DownloadButton_text_covercolor, Color.WHITE);
        backgroud_strokeWidth = a.getDimension(R.styleable.DownloadButton_backgroud_strokeWidth, 3F);
        mNormalText = a.getString(R.styleable.DownloadButton_text_normal);
        mDowningText = a.getString(R.styleable.DownloadButton_text_downing);
        mFinishText = a.getString(R.styleable.DownloadButton_text_finish);
        mPauseText = a.getString(R.styleable.DownloadButton_text_pause);
        mAnimationDuration = a.getInt(R.styleable.DownloadButton_animation_duration, 500);
        a.recycle();
    }
